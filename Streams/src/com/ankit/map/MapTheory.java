...
//  map() method will transform the data from the source and
//	we can get that data into target
//  It means whatever the data or object in the collections
//	by using map we can transform it	
