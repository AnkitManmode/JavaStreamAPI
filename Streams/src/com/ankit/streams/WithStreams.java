...
// we have a collection having no. of elements or objects , 
...
//  first of all we need to add this methods to the string, then we can process the data	
...
// once condition is verified , then we collecting data by collect method, and put the data in another list 	
...
//	List<Integer>evenNumbersList = new ArrayList<Integer>();
	...
	// Its a consumer type lambda expression
	// foreach method take consumer arguments 
	// we are adding this collection to the stream , then we are filtering ,
	// after filtering whatever data we are getting ,
	// getting each and every element , and passing that data into the lambda expression 
