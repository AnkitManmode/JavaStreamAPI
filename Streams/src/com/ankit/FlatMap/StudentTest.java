...
// we have new stream now and we add stud1, stud2 list in the new stream
// then we apply flatMap method, from the new stream we have pass the variable as the flat map in the stream	
